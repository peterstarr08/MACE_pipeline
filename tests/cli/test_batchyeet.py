...
from mace_aze.cli.batch_yeet import validate_arguments, collect_frames, export_config
...
def test_export_frames(mocker, atoms_records, read_io_save_path):
    ...
    mock_full_path = mocker.patch("mace_aze.cli.batch_yeet.RawDataset.full_path")
